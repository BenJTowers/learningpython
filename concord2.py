...
import sys
import re
#no functions cause I am no longer functioning
def main():
    ...
    #print out all the sentences with the correct amount of spaces at the front to aline the sentences with the 30th column
    output = []
